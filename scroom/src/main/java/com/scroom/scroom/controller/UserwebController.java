...
public class UserwebController {
    ...
    @GetMapping("/findproyects/{userName}")
    public List<Proyect> findProyectsByUserweb(@PathVariable String userName){
        return userwebService.findProyectsByUserweb(userName);
    }
}
